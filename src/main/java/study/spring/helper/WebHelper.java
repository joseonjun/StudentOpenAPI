...
public class WebHelper {
	...
	/**
	 * WebHelper 기능을 초기화 한다. JSP의 내장객체는 JSP 페이지에서만 생성되기 때문에, 일반 Java 클래스에서 접근하기 위해서는
	 * JSP 페이지에서 전달받아야 한다.
	 */
	public void init() {
		/** JSP 내장 객체를 담고 있는 Spring의 객체를 통해서 내장 객체 획득하기 */
		ServletRequestAttributes requestAttr = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();

		// request 와 response 객체를 추출한다.
	...
	// 기존값에 대한 redirect 개선 -> // void ->ModelAndView 로 개선.
