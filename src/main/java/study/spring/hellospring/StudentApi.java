...
//		if (studno == 0) 	{ web.printJsonRt("학과번호을 입력하세요"); 	return; }
		if (grade == 0) 			{ web.printJsonRt("학년를 입력하세요"); 	return; }
		if (idnum == null) 	{ web.printJsonRt("주민번호을 입력하세요"); 	return; }
		if (birthdate == null) 		{ web.printJsonRt("생년월일를 입력하세요"); return; }
...
//		if (profno == 0) 		{ web.printJsonRt("담당 교수번호를 입력하세요"); return; }
...
//		student.setStudno(studno);
		...
		/*
		 * if (profno == 0) { student.setProfno(0); } else { }
		 */
