				...
				<form method="get" action="${pageContext.request.contextPath}/student/stud_list.do" style="width: 300px;">
					<div class="input-group">
						<input type="text" name='keyword' class="form-control"
							...
							</button> <a href="${pageContext.request.contextPath}/student/stud_add.do"
		...
		<table class="table">
			<thead>
				<tr>
					...
					<th class="info text-center">교수담당번호</th>
				</tr>
			</thead>
			<tbody>
				<c:choose>
					<c:when test="${fn:length(list) > 0}">
						<c:forEach var="item" items="${list}">
							<tr>
								...
								<td><c:url var="readUrl" value="/student/stud_view.do">
										<c:param name="studno" value="${item.studno}"></c:param>
